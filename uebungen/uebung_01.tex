...
\begin{info-popup}
  Nach laden des Schemas können alle Tabellen oder Views einen Befehl in SQL-Plus ausgegeben werden. \\
...
Modifiziere Aufgabe \ref{sec:uebung_01.aufgabe_03} so, dass nur Mitarbeiter angezeigt werden, deren Vorname mit einem \textbf{A} beginnt.
...
Gebe alle Mitarbeiter aus, die an vierter Stelle ein \textbf{I} oder ein \textbf{ß} besitzen.
...
Gebe alle Kontakte aus, die der Firma \textbf{Thyssen} angehören uns suche nach Personen, deren Telefonnummer auf \textbf{0221} endet.
